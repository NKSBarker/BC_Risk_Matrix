...
``` {r load.xy}
xy<- data.table(drop_read_csv("BAM/data/BC_Risk_Matrix/BC_COFI_XY.csv"))
...
``` {r}
ss.covar <- data.table(drop_read_csv("BAM/data/BC_Risk_Matrix/covariatesforoffsetMay2017Timezone_manuallyFixed.csv"), header=T)
colnames(ss.covar)
