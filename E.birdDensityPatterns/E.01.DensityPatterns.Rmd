...
ggplot(test, aes(x=ForAge, y=PredDens_ForID, fill=ForHt)) + geom_boxplot(na.rm=FALSE) + xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme2 + coord_cartesian(ylim=range(totalBirds$PredDens_ForID) + c(-1, 1)) + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") 

ggplot(test, aes(x=ForAge, y=PredDens_ForID, fill=ForHt)) + geom_boxplot(na.rm=FALSE) + xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme5 + coord_cartesian(ylim=range(totalBirds$PredDens_ForID) + c(-1, 1)) + geom_point(data=rank.aggregates[[1]], aes(x=ForAge, y=FinalRank+20, col=ForHt), position=position_dodge(width=.75), size=4, show.legend = F) + geom_text(data=rank.aggregates[[1]], aes(x=ForAge, y=FinalRank+21, label=round(FinalRank,1)), position=position_dodge(width=0.75), size=3.1)  + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") + geom_hline(yintercept=20) + geom_text(aes(x=1, y=26), label="Rank from Matrix", col="black", size=5)
...
ggplot(totalBirds, aes(x=ForAge, y=Count, fill=ForHt)) + geom_boxplot() + xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme2 + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") 

ggplot(totalBirds, aes(x=ForAge, y=Count, fill=ForHt, col=ForHt)) + geom_violin() + xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme2 + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") 
```
...
lapply(1:length(tota.bec), function(i) {
  ggplot(tota.bec[[i]], aes(x=ForAge, y=PredDens_ForID, fill=ForHt)) + geom_boxplot() + facet_wrap(~BEC) + xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme2 + coord_cartesian(ylim=range(totalBirds$PredDens_ForID) + c(-1, 1))   + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") 
    ggplot(tota.bec[[i]], aes(x=ForAge, y=PredDens_ForID, fill=ForHt)) + geom_boxplot() + facet_wrap(~BEC) + xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme5 + coord_cartesian(ylim=range(totalBirds$PredDens_ForID) + c(-1, 1)) + geom_point(data=rank.agg.bec[[i]], aes(x=ForAge, y=FinalRank+20, col=ForHt), position=position_dodge(width=.75), size=4, show.legend = F) + geom_text(data=rank.agg.bec[[i]], aes(x=ForAge, y=FinalRank+21, label=round(FinalRank,1)), position=position_dodge(width=0.75), size=3.1)  + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") + geom_hline(yintercept=20) + geom_text(aes(x=1, y=26), label="Rank from Matrix", col="black", size=5)
})
...
lapply(1:length(tota.sg), function(i) {
  ggplot(tota.sg[[i]], aes(x=ForAge, y=PredDens_ForID, fill=ForHt)) + geom_boxplot() + facet_wrap(~SpeciesGroup) + xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme2 + coord_cartesian(ylim=range(totalBirds$PredDens_ForID) + c(-1, 1))   + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") 
    ggplot(tota.sg[[i]], aes(x=ForAge, y=PredDens_ForID, fill=ForHt)) + geom_boxplot() + facet_wrap(~SpeciesGroup) + xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme5 + coord_cartesian(ylim=range(totalBirds$PredDens_ForID) + c(-1, 1)) + geom_point(data=rank.agg.sg[[i]], aes(x=ForAge, y=FinalRank+20, col=ForHt), position=position_dodge(width=.75), size=4, show.legend = F) + geom_text(data=rank.agg.sg[[i]], aes(x=ForAge, y=FinalRank+21, label=round(FinalRank,1)), position=position_dodge(width=0.75), size=3.1)  + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") + geom_hline(yintercept=20) + geom_text(aes(x=1, y=26), label="Rank from Matrix", col="black", size=5)
})
...
# create table of ranks for all combinations of attributes for plotting
...
lapply(1:length(tota.becsg), function(i) {
  ...
  ggplot(tota.becsg[[i]], aes(x=ForAge, y=PredDens_ForID, fill=ForHt, group=ForHt)) + geom_point(aes(col=ForHt), size=3, position=position_dodge(width=0.8)) + facet_wrap(~BEC.Species)+ xlab("Forest Age") + ylab("Mean Density per Forest Stand Type") + myfacettheme5 + coord_cartesian(ylim=range(totalBirds$PredDens_ForID) + c(-1, 1))  + geom_point(data=ranks.split[[i]], aes(x=ForAge, y=FinalRank+20, col=ForHt), position=position_dodge(width=.75), size=4, show.legend = F) + geom_text(data=ranks.split[[i]], aes(x=ForAge, y=FinalRank+21, label=round(FinalRank,1)), position=position_dodge(width=0.75), size=3.1)  + scale_colour_manual(values=palht, name="Height Class") + scale_fill_manual(values=palht, name="Height Class") + geom_hline(yintercept=20) + geom_text(aes(x=1, y=26), label="Rank from Matrix", col="black", size=5)
})
